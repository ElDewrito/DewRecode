...
namespace Blam
{
	...
	const std::string GameTypeNames[(uint32_t)GameType::Count] =
	{
		"none",
		"ctf",
		"slayer",
	...
	const std::string GameModeNames[(uint32_t)GameMode::Count] =
	{
		"none",
		"campaign",
		"multiplayer",
	...
	const std::string CameraTypeNames[(uint32_t)CameraType::Count] =
	{
		"following",
		"orbiting",
		"flying",
	...
	enum class ServerLobbyMode : uint32_t
	{
		XboxLiveOpen = 0,
		XboxLiveFriendsOnly,
		XboxLiveInviteOnly,
	...
	const std::string ServerLobbyModeNames[(uint32_t)ServerLobbyMode::Count] =
	{
		"XboxLiveOpen",
		"XboxLiveFriendsOnly",
		"XboxLiveInviteOnly",
