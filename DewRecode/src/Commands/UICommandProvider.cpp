...
namespace UI
{
	...
	bool UICommandProvider::CommandShowH3UI(const std::vector<std::string>& Arguments, ICommandContext& context)
	{
		if (Arguments.size() <= 0)
		{
	...
	bool UICommandProvider::CommandSettingsMenu(const std::vector<std::string>& Arguments, ICommandContext& context)
	{
