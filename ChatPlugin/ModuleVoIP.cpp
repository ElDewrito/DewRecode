...
namespace
{
	bool VariablePushToTalkUpdate(const std::vector<std::string>& Arguments, CommandContext& context)
	{
		unsigned int error;
	...
	bool VariableVolumeModifierUpdate(const std::vector<std::string>& Arguments, CommandContext& context)
	{
		unsigned int error;
		uint64 scHandlerID = VoIPGetscHandlerID();
		if (scHandlerID != NULL)
	...
	bool VariableAGCUpdate(const std::vector<std::string>& Arguments, CommandContext& context)
	{
		unsigned int error;
		uint64 scHandlerID = VoIPGetscHandlerID();
		if (scHandlerID != NULL)
	...
	bool VariableEchoCancellationUpdate(const std::vector<std::string>& Arguments, CommandContext& context)
	{
		unsigned int error;
		uint64 scHandlerID = VoIPGetscHandlerID();
		if (scHandlerID != NULL)
	...
	bool VariableVADLevelUpdate(const std::vector<std::string>& Arguments, CommandContext& context)
	{
		unsigned int error;
		uint64 scHandlerID = VoIPGetscHandlerID();
		if (scHandlerID != NULL)
	...
	bool VariableServerEnabledUpdate(const std::vector<std::string>& Arguments, CommandContext& context)
	{
